Shader"Lit/WireframeShader"
{
    Properties
    {
        ...
        _WireframeColour("Wireframe colour", Color) = (0.0, 0.8962264, 0.0, 1.0)
        _WireframeAliasing("Wireframe aliasing", float) = 3
    }
    SubShader
    {
        Tags { "RenderType"="Opaque"}
        LOD 200
        // To blend in wireframe
        ...
        Pass
        {
            ...
            // Add barycentric variables to geometry struct
            struct g2f {
            ...
            // Applies barycentric coords to each vertex
            [maxvertexcount(3)]
            void geom(triangle v2f IN[3], inout TriangleStream<g2f> triStream) {
                ...
                // if statements not usually good
            ...
            fixed4 frag(g2f i) : SV_Target
            {
                ...
                // use coord closest to edge
                float alpha = 1 - min(aliased.x, min(aliased.y, aliased.z));
                // Set to forwards facing wireframe colour
